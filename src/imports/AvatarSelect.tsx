import svgPaths from "./svg-4zduh6fkaq";
...
function Heading() {
  return (
    <div className="absolute h-[36.918px] left-[-0.61px] top-[145.39px] w-[391.359px]" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] leading-[38.585px] left-[196.5px] not-italic text-[#1d3da0] text-[32.154px] text-center top-[-9px] whitespace-nowrap">Choose your avatar</p>
    </div>
  );
}
...
function Button12() {
  return (
    <div className="absolute h-[49.201px] left-[0.39px] top-[722.39px] w-[391.359px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Poppins:Medium',sans-serif] leading-[24.615px] left-[195.61px] not-italic text-[16.41px] text-black text-center top-[10.67px] whitespace-nowrap">Skip for now</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[23.975px] left-[-3.61px] top-[600.39px] w-[381.575px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[190.33px] not-italic text-[#8b6bb8] text-[0px] text-[16px] text-center top-[-1.6px] whitespace-nowrap">
        <span className="leading-[24px] text-[#0a0216]">Selected</span>
        <span className="leading-[24px] text-black">:</span>
        <span className="leading-[24px]">{` `}</span>
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] text-black">Lemon</span>
      </p>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="relative shrink-0 size-[21.981px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.9807 21.9807">
        <g id="Icon">
          <path d={svgPaths.p672c244} id="Vector" stroke="var(--stroke-0, #6B4C9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.74759" />
        </g>
      </svg>
    </div>
  );
...
function Container4() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[159px] pr-[0.024px] rounded-[47104300px] size-[35.179px] top-[424px]" data-name="Container">
      <Icon />
    </div>
  );
}
...
function Button13() {
  return (
    <div className="absolute bg-[#14296b] h-[59.991px] left-[29px] rounded-[48315984px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.08)] top-[666px] w-[381.575px]" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] left-[190.67px] not-italic text-[18px] text-center text-white top-[14.39px] whitespace-nowrap">Continue</p>
    </div>
  );
}
...
export default function AvatarSelect() {
  return (
    <div className="bg-white relative size-full" data-name="Avatar-Select">
      <Container />
      <Container4 />
      <Button13 />
    </div>
