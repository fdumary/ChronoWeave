function Heading() {
  return (
    <div className="absolute h-[50px] left-0 top-[130px] w-[391.359px]" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] leading-[38.585px] left-[194.91px] not-italic text-[#1d3da0] text-[37px] text-center top-[-2.88px] whitespace-nowrap">Create your account</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute h-[907.7px] left-[24px] top-[24px] w-[391.359px]" data-name="Container">
      <Heading />
      <Container1 />
      <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] leading-[24.615px] left-[193px] not-italic text-[19.41px] text-black text-center top-[180px] w-[286px]">Start understanding your time perception</p>
      <Form />
      <Button1 />
      <Paragraph />
