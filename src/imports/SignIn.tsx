function Heading() {
  return (
    <div className="absolute font-['Poppins:Regular',sans-serif] h-[36.921px] left-[1.39px] not-italic text-center top-[186.39px] w-[391.391px] whitespace-nowrap" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute leading-[24.615px] left-[193.39px] text-[19.41px] text-black top-[47.36px]">Continue your time journey</p>
      <p className="-translate-x-1/2 absolute leading-[38.585px] left-[195.17px] text-[#1d3da0] text-[37px] top-[-2.88px]">Welcome back</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[#14296b] h-[61.534px] left-0 rounded-[48315984px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.08)] top-[292px] w-[391.391px]" data-name="Button">
...
function Form() {
  return (
    <div className="-translate-y-1/2 absolute h-[259.97px] left-[0.39px] top-[calc(50%-38.51px)] w-[391.391px]" data-name="Form">
      <Container1 />
      <Button1 />
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[24.591px] left-[-12.61px] top-[665.39px] w-[391.391px]" data-name="Paragraph">
      <Button2 />
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute h-[907.772px] left-[24.61px] top-[24.61px] w-[391.391px]" data-name="Container">
      ...
      <Form />
      <Paragraph />
      <p className="-translate-x-1/2 absolute font-['Poppins:Regular',sans-serif] leading-[24.615px] left-[154.39px] not-italic text-[16.41px] text-black text-center top-[665.39px] whitespace-nowrap">{`Don't have an account? `}</p>
    </div>
  );
}
